...
<head>
    ...
    <style>
        ...
        .messages { height: 300px; overflow-y: scroll; border: 1px solid #ccc; padding: 1rem; border-radius: 0.5rem; text-align: left; background: url("https://i.pinimg.com/originals/c3/0c/e8/c30ce876948646203d29f46dffd040d8.jpg"); }
        .msg { margin: 0.5rem 0; }
